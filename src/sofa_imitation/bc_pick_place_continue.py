...
def hydra_run(cfg: DictConfig):
    ...
    wandb.init(project="Imitation_Sofa_PickAndPlace", config=OmegaConf.to_container(cfg, resolve=True),
               settings=wandb.Settings(start_method="thread"), notes='', resume='5b6kv106')
